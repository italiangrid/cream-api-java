...
public class Activity extends ActivityDescription {
    ...
    public static final String EXCLUSIVE_EXECUTION = "EXCLUSIVE_EXECUTION";
    ...
    public static final String PARALLEL_ENVIRONMENT_PROCESSES_PER_HOST = "PARALLEL_ENVIRONMENT_PROCESSES_PER_HOST";
    public static final String PARALLEL_ENVIRONMENT_THREADS_PER_PROCESSES = "PARALLEL_ENVIRONMENT_THREADS_PER_PROCESSES";
    public static final String PARALLEL_ENVIRONMENT_TYPE = "PARALLEL_ENVIRONMENT_TYPE";
    public static final String SANDBOX_PATH = "SANDBOX_PATH";
    public static final String SERVICE_URL = "SERVICE_URL";
    public static final String SLOTS_PER_HOST = "SLOTS_PER_HOST";
