...
public interface NotificationOnStateTableInterface {
    
    public static final String NOTIFICATION_ID_LABEL = "notification_id";
    public static final String ONSTATE_LABEL = "onstate";
